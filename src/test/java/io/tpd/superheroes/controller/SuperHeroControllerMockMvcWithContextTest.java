...
// This loads a partial WebApplicationContext not the WebServer hence it also loads all the dependencies automatically
// So the @MockBean is needed to override the real repository used in the application.
...
public class SuperHeroControllerMockMvcWithContextTest {
    ...
    @MockBean // See explanation above
